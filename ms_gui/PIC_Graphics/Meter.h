...
/* ************************************************************************** */									
// Overview:
// The following are the settings to select the type if meter shape.
// There are three types: 
//		a. MTR_QUARTER_TYPE
//		b. MTR_HALF_TYPE
//	    c. MTR_WHOLE_TYPE
// Only one will be enabled at a time. This is done to save code space.
// Depending on the type chosen, the meter normal, critical and danger 
// ranges are defined automatically.
/* ************************************************************************** */	

// Select the type by enabling one of the defines.
#define MTR_WHOLE_TYPE				// Meter drawn with 6 octants used.
//#define MTR_HALF_TYPE				// Meter drawn with semi circle shape.
//#define MTR_QUARTER_TYPE				// Meter drawn with quarter circle shape.

// These selects the other parameters of the meter that are dependent on the shape.
#if defined (MTR_WHOLE_TYPE) 		
...
*			based on parameter 2 of the message given.
*
* PreCondition: none
*
